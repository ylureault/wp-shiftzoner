...
<div class="community-page">
    ...
    <div class="container">
        ...
        <section class="community-features-section">
            <h2 class="section-title" data-animate="fade-up">Explorer la Communauté</h2>
            <p class="section-subtitle" data-animate="fade-up" data-delay="50">
                Toutes les fonctionnalités pour profiter au maximum de ShiftZoneR
            </p>

            <div class="features-grid" data-animate="fade-up" data-delay="100">
                <div class="feature-card">
                    ...
                    <p>Explorez des milliers de photos automobiles classées par marque et modèle</p>
                    <a href="<?php echo esc_url( home_url( '/galerie/' ) ); ?>" class="feature-link">
                        Explorer la galerie →
                    </a>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <p>Découvrez les lieux de prise de vue sur une carte interactive</p>
                    <a href="<?php echo esc_url( home_url( '/carte/' ) ); ?>" class="feature-link">
                        Voir la carte →
                    </a>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <h3>Groupes de Modèles</h3>
                    <p>Rejoignez des groupes de passionnés de modèles spécifiques</p>
                    <a href="<?php echo esc_url( home_url( '/groupes/' ) ); ?>" class="feature-link">
                        Voir les groupes →
                    </a>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <h3>Marques & Modèles</h3>
                    <p>Naviguez facilement entre marques, modèles et leurs photos</p>
                    <a href="<?php echo esc_url( home_url( '/marques-et-modeles/' ) ); ?>" class="feature-link">
                ...
                <div class="feature-card highlight">
                    ...
                    <p>Rejoignez la communauté pour publier, commenter et voter</p>
                    <a href="<?php echo esc_url( home_url( '/inscription/' ) ); ?>" class="feature-link primary">
                ...
                <div class="feature-card highlight">
                    ...
                    <p>Partagez vos plus belles prises de vue automobiles</p>
                    <a href="<?php echo esc_url( home_url( '/soumettre-ma-photo/' ) ); ?>" class="feature-link primary">
                        Publier maintenant →
                    </a>
                </div>
                <?php endif; ?>
                ...
                <div class="feature-card">
                    ...
                    <h3>Classements</h3>
                    <p>Découvrez les top contributeurs et photos les plus votées</p>
                    <a href="#top-contributors" class="feature-link" onclick="document.getElementById('top-contributors').scrollIntoView({behavior: 'smooth'});">
                        Voir le classement →
                    </a>
                </div>
            </div>
